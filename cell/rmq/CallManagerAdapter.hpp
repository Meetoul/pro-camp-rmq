  ...
  public:
    ...
    void activeRMQ()
    {
        ...
        channel_.declareExchange("caller", AMQP::topic).onSuccess([]() {
            std::cout << "declared caller exchange " << std::endl;
        });
        ...
        channel_.consume("caller", AMQP::noack).onReceived([this](const AMQP::Message &message, uint64_t deliveryTag, bool redelivered) {
